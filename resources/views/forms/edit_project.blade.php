...
{!! Form::model($project, ['method' => 'POST', 'route' => ['projects.update', $project->id], 'class' => 'form-horizontal', 'id' => 'edit-project-form']) !!}
...
{!! Form::token() !!}
    ...
    <div class="form-group">
        ...
        {{ Form::textarea('references', isset($project->references) ? implode("\n", $project->references) : "", 
            ['class' => 'form-control'])
        }}
    </div>
    ...
    <div class="text-center" style="margin-top: 5%;">
        ...
        <button id="add-btn" type="submit" class="btn btn-primary">Editează</button>
    </div>
